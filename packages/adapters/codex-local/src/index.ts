...
- Unless explicitly overridden in adapter config, Paperclip runs Codex with a per-company managed CODEX_HOME under the active Paperclip instance and seeds auth/config from the shared Codex home. That source is resolved in this order: the CODEX_HOME env var, then PAPERCLIP_HOME/.codex, then ~/.codex.
